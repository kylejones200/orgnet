...
from onapy.data.models import Interaction, Meeting, Document, CodeCommit
from onapy.data.processors import DataProcessor
...
class EdgeWeightCalculator:
    ...
    def compute_communication_weights(
        self, interactions: list[Interaction], now: Optional[datetime] = None
    ) -> pd.DataFrame:
        """
        Compute communication edge weights with recency, reciprocity, and responsiveness.
