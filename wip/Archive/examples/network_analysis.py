...
from network_analysis.influence import compute_influence_metrics, rank_influencers
from network_analysis.bridges import analyze_bridge_structure
...
def main():
    ...
    if bridges.bridge_nodes:
        ...
        from network_analysis.bridges import identify_critical_bridges
